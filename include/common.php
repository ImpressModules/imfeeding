...
// Loading IcmsSimpleRSS
$simplerss_filename = ICMS_ROOT_PATH . '/class/icmssimplerss.php';
if (!file_exists($simplerss_filename)) $simplerss_filename = IMFEEDING_ROOT_PATH . 'class/icmssimplerss.php';
include_once($simplerss_filename);
