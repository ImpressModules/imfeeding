 ...
 */
/*function imfeeding_db_upgrade_1() {
}
function imfeeding_db_upgrade_2() {
}*/

function xoops_module_update_imfeeding($module) {
	/**
...
function xoops_module_install_imfeeding($module) {
